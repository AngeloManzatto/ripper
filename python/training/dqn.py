"""
Created on Sun Aug 30 21:43:34 2026
...
checkpoint_dir = Path("python") / "training" / "checkpoints" / "dqn"
checkpoint_dir.mkdir(parents=True,exist_ok=True)

checkpoint_path      = checkpoint_dir / "dqn_weights.pt"
best_checkpoint_path = checkpoint_dir / "dqn_weights_best.pt"
...
policy_net = DQN(height=height, width=width).to(device)
target_net = DQN(height=height, width=width).to(device)
